...
| 13 | Floor — map-routing refactor + market-watch hardening | Frontend (App, FKeyBar, MarketWatch, format) | Line-by-line review of the routing refactor and formatter guards, 60+ fmt.* call-site sweep, keyboard/aria/regression analysis; 0C/0H/2M/6L, all actionable findings fixed | 0 open |
